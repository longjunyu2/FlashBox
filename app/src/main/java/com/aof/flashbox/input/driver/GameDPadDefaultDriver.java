...
public class GameDPadDefaultDriver extends BaseDriver {

    private DPadView.Dir lastDir = DPadView.Dir.CENTER;

    public GameDPadDefaultDriver(GameDPadLayerConfig config) {
        super(config);
    }
     ...
     * @return 键
     */
    private List<KeyCodes.Codes> getKeys(DPadView.Dir dir) {
    ...
    public void right_up() {
        switch (lastDir) {
            ...
            default:
                genInputEvent(getKeys(lastDir), KeyEvent.Action.Up);
            case CENTER:
                genInputEvent(getKeys(DPadView.Dir.RIGHT_UP), KeyEvent.Action.Down);
        }
        lastDir = DPadView.Dir.RIGHT_UP;
    }
    ...
    public void right_down() {
        switch (lastDir) {
            ...
            default:
                genInputEvent(getKeys(lastDir), KeyEvent.Action.Up);
            case CENTER:
                genInputEvent(getKeys(DPadView.Dir.RIGHT_DOWN), KeyEvent.Action.Down);
        }
        lastDir = DPadView.Dir.RIGHT_DOWN;
    }
    ...
    public void left_up() {
        switch (lastDir) {
            ...
            default:
                genInputEvent(getKeys(lastDir), KeyEvent.Action.Up);
            case CENTER:
                genInputEvent(getKeys(DPadView.Dir.LEFT_UP), KeyEvent.Action.Down);
        }
        lastDir = DPadView.Dir.LEFT_UP;
    }
    ...
    public void left_down() {
        switch (lastDir) {
            ...
            default:
                genInputEvent(getKeys(lastDir), KeyEvent.Action.Up);
            case CENTER:
                genInputEvent(getKeys(DPadView.Dir.LEFT_DOWN), KeyEvent.Action.Down);
        }
        lastDir = DPadView.Dir.LEFT_DOWN;
    }
