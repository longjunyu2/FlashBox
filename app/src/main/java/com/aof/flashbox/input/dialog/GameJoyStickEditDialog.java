...
public class GameJoyStickEditDialog extends AppCompatDialog {

    private final GameJoystickLayerConfig config;

    private OnEditFinishedCallback finishedCallback;

    public GameJoyStickEditDialog(@NonNull Context context, GameJoystickLayerConfig config) {
        super(context);
